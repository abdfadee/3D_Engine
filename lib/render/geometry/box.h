...
public:
    BoxGeometry(double width, double height, double depth,
        ...
        createPlane({ 1, 0, 0 }, { 0, 1, 0 }, { 0, 0, 1 }, width, height, depth, widthSegments, heightSegments); // Front
        createPlane({ -1, 0, 0 }, { 0, 1, 0 }, { 0, 0, -1 }, width, height, depth, widthSegments, heightSegments); // Back
        createPlane({ 0, 1, 0 }, { 1, 0, 0 }, { 0, 0, 1 }, height, width, depth, heightSegments, widthSegments); // Top
        createPlane({ 0, -1, 0 }, { 1, 0, 0 }, { 0, 0, -1 }, height, width, depth, heightSegments, widthSegments); // Bottom
        createPlane({ 0, 0, 1 }, { 1, 0, 0 }, { 0, 1, 0 }, depth, width, height, depthSegments, widthSegments); // Right
        createPlane({ 0, 0, -1 }, { 1, 0, 0 }, { 0, 1, 0 }, depth, width, height, depthSegments, widthSegments); // Left
        generateBuffer();
    }
